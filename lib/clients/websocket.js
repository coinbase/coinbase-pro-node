 ...
 * @param {String[]} [channels] - The GDAX channels to listen to. Default: ['full']
...
class WebsocketClient extends EventEmitter {
  constructor(productIDs, channels, websocketURI = 'wss://ws-feed.gdax.com', auth) {
    super();
    this.productIDs = Utils.determineProductIDs(productIDs);
    this.channels = Utils.determineChannels(channels);
