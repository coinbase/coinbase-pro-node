...
class PublicClient {
  ...
  makeRequestCallback(resolve, reject) {
  ...
  request(method, uriParts, opts = {}, callback) {
    ...
    const p = new Promise((resolve, reject) => {
      request(opts, this.makeRequestCallback(resolve, reject));
    });

    if (callback) {
      p.then(({ data, response }) => setImmediate(() => callback(null, data, response)))
      .catch(e => setImmediate(() => callback(e)));
    }
